...
- Where the product does something its own named, checkable rule says it must not, record the rule and the exact place side by side — the judge takes it from there. A vibe mismatch goes in as a felt report for the owner's taste call — never quietly "fixed" toward your own aesthetic, never converted into a verdict.

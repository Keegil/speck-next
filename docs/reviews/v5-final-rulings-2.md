...
- `c4` — `/private/tmp/claude-501/-Users-kjetil-Code-speck/a0e0d32c-31ec-4aba-a433-2bd88364f16f/scratchpad/jot-run-c4`
- `c5` — `/private/tmp/claude-501/-Users-kjetil-Code-speck/a0e0d32c-31ec-4aba-a433-2bd88364f16f/scratchpad/jot-run-c5`
- `c6` — `/private/tmp/claude-501/-Users-kjetil-Code-speck/a0e0d32c-31ec-4aba-a433-2bd88364f16f/scratchpad/jot-run-c6`
...
- Odd remains the in-anger proof that the hearing improves a real product campaign rather than only fixtures (`state.md:20-22`; `capabilities.md:8`).

...
**Hearing receipt** *(opened at dispatch, records appended on return)*: built [quote the `state.md` line that says Built, and the commit that wrote it — a hearing opens on Built work only] · experiencers [per persona: tool, model, session] · dispatched [date, commit] · walks and commands [planned] · owner of this run [which session] · if a record is empty [re-dispatch under your own named line] · records and verdicts [linked — each verdict pointing at lived moments].

...
23. What does each of Product, Business, Experience, and Engineering protect for this product? For Business and Experience, what observable condition calls the role, what direct current evidence may keep it out, when does that evidence expire, and which changes are material enough to call it? If the answer is uncertain later, the role joins. Does a product-specific specialist need one responsibility now, and what observed event ends that assignment?

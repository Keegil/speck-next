...
- Pilot remains the in-anger proof that the hearing improves a real product campaign, and `milestone: v5-proven-in-anger` remains open until that experience exists (`map.md:5-11`; `state.md:22`).
